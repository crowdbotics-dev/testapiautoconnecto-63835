...
## Project Structure
    ...
    ├── testapiautoconnecto_63835  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_63835`
...
2. Clone this repo and `cd testapiautoconnecto_63835`
